/*
  Sub-distributor reference, dated history for dim_clientsd SCD2.

  Was: kind SEED over ../../seeds/clientsd_data.csv
  ...
  raw.clientsd_data needs no edit.
...
MODEL (
  ...
  description 'Sub-distributor reference, dated history for dim_clientsd SCD2'
);

SELECT t.*
FROM landing.clientsd_data t

/*
  Sell-in lines, non-destocké channel.

  Was: kind SEED over ../../seeds/kp_sd_non_destocke_data.csv
  ...
  raw.kp_sd_non_destocke_data needs no edit.
...
*/
MODEL (
  name raw.kp_sd_non_destocke_data,
  kind VIEW,
  owner analytics_team,
  description 'Sell-in lines, non-destocké channel'
);

SELECT t.*
FROM landing.kp_sd_non_destocke_data t

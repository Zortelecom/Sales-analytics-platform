/*
  Monthly targets per salesperson and category.

  Was: kind SEED over ../../seeds/targets_data.csv
  ...
  raw.targets_data needs no edit.
...
MODEL (
  ...
  description 'Monthly targets per salesperson and category'
);

SELECT t.*
FROM landing.targets_data t

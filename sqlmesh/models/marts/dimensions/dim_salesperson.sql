/*
  Salesperson dimension, historised on effective_from.
  ...
  snapshot against what is already stored. stg_salesteam_data is the opposite --
...
MODEL (
  ...
  audits (
    ...
    not_null(columns := (salesperson_key, salesperson_id, valid_from)),
    ...
    *,
    ...
    CASE
      WHEN ROW_NUMBER() OVER (
             PARTITION BY salesperson_id ORDER BY effective_from
           ) = 1

/*
  Sub-distributor dimension, historised on effective_from.
  ...
  snapshot against what is already stored. stg_clientsd_data is the opposite --
...
MODEL (
  ...
  audits (
    ...
    not_null(columns := (clientsd_key, sd_id, valid_from)),
    ...
    *,
    ...
    CASE
      WHEN ROW_NUMBER() OVER (
             PARTITION BY sd_id ORDER BY effective_from
           ) = 1
